                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('product_name') border-danger @enderror" type="text" value="{{ old('product_name') ?? $product->product_name }}" name="product_name" id="product_name">
                                @error('product_name')
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('description') border-danger @enderror" type="text" value="{{ old('description') ?? $product->description }}" name="description" id="description">
                                @error('description')
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('style') border-danger @enderror" type="text" value="{{ old('style') ?? $product->style }}" name="style" id="style">
                                @error('style')
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('brand') border-danger @enderror" type="text" value="{{ old('brand') ?? $product->brand }}" name="brand" id="brand">
                                @error('brand')
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('url') border-danger @enderror" type="text" value="{{ old('url') ?? $product->url }}" name="url" id="url">
                                @error('url')
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('product_type') border-danger @enderror" type="text" value="{{ old('product_type') ?? $product->product_type }}" name="product_type" id="product_type">
                                @error('product_type')
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('note') border-danger @enderror" type="text" value="{{ old('note') ?? $product->note }}" name="note" id="note">
                                @error('note')
